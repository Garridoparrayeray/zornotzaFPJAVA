...
public class PantailaKlaseak extends JFrame {
	...
	public JButton getBtnIrten() {
		return btnIrten;
	}

	public JPanel getPanelFormularioa() {
		return panelFormularioa;
	}

	public JTextField getTxtIzena() {
		return txtIzena;
	}

	public JTextField getTxtInstruktorea() {
		return txtInstruktorea;
	}

	public JTextField getTxtOrdutegia() {
		return txtOrdutegia;
	}

	public JButton getBtnGorde() {
		return btnGorde;
	}

	public JButton getBtnUtzi() {
		return btnUtzi;
	}
}