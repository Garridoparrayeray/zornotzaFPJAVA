...
/**
 * Gela bat aldatzeko leihoa
 */
public class LeihoGelaAldatu extends JFrame {

    public JLabel lblId = new JLabel("ID (aldatu nahi den gela):");
    ...
    public LeihoGelaAldatu() {
        setTitle("Gela Aldatu");
        setSize(400, 470);
