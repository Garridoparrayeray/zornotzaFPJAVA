...
/**
 * Leihoa bezero bat ezabatzeko
 */
public class LeihoBezeroaEzabatu extends JFrame {

    public JLabel lblId = new JLabel("Ezabatu nahi duzun bezeroaren ID:");
    ...
    public LeihoBezeroaEzabatu(){
        setTitle("Bezeroa Ezabatu");
        setSize(400,300);
