...
public class LoginPantaila extends JFrame {
	...
	public LoginPantaila() {
		setTitle("Saioa hasi - Hotela"); // <-- adib: Liburutegia, Albaitaritza
		setSize(420, 220);
		...
		gbc.gridx = 0;
		gbc.gridy = 0;
		panelGoia.add(lblIzena, gbc);
		gbc.gridx = 1;
		panelGoia.add(txtIzena, gbc);
		gbc.gridx = 0;
		gbc.gridy = 1;
		panelGoia.add(lblPasahitza, gbc);
		gbc.gridx = 1;
		panelGoia.add(txtPasahitza, gbc);
